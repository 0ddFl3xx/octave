      ...
      {isFullScreen && (
        <DominantColorExtractor imageUrl={currentTrack.imageUrl}>
          {(dominantColor) => {
            ...
            return (
              <div
                className="fixed inset-0 flex lg:hidden flex-col items-center justify-center pt-2 z-50"
                style={{ background: gradientBackground }}>
                <div className="fixed inset-0 flex lg:hidden flex-col items-center justify-center pt-2 z-50">
